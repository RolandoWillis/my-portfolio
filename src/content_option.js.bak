const logotext = "ROLANDO";
const meta = {
    title: "Rolando Willis",
    description: "I’m rolando willis Full stack devloper, currently working in Denmark",
};

const introdata = {
    title: "I’m Rolando Willis",
    animated: {
        first: "I love coding",
        second: "I code cool websites",
        third: "I develop mobile apps",
    },
    description: "Experienced software developer proficient in many platforms and tools, focused on delivering business value through quality software.",
...
const customblockchainportfolio = [
    {
        img: "images/mugambo.png",
        desctiption: "Mugambo Blockchain Explorer.",
        link: "https://mgbscan.com/",
    },
    {
        img: "images/WYZTH.png",
        desctiption: "WYZTH Blockchain Explorer",
        link: "https://wyzthscan.org/",
    },
];

const dexportfolio = [
    {
        img: "images/babylonswap.png",
        desctiption: "The best decentralized exchange on the world.",
        link: "https://babylonswap.finance/",
    },
];

const marketplaceportfolio = [    
    {
        img: "images/blockbar.png",
        desctiption: "NFT marketplace on Ethereum",
        link: "https://blockbar.com/",
    },
    {
        img: "images/artz.png",
        desctiption: "NFT marketplace on Solana",
        link: "https://artz.ai/",
    },
    {
        img: "images/lofi.png",
        desctiption: "NFT marketplace on BSC.",
        link: "http://staging.lofi-market.com/",
    },
];

const mintingsiteportfolio = [
    {
        img: "images/flinch.png",
        desctiption: "Fllinch NFT(ETH)",
        link: "https://www.flinchthemovie.com/",
    },
    {
        img: "images/troverse.png",
        desctiption: "Troverse NFT(ERC721A)",
        link: "https://troverse.io/",
    },
    {
        img: "images/cryptobullsociety.png",
        desctiption: "Bull NFT",
        link: "https://cryptobullsociety.com",
    },
    {
        img: "images/tokenpuss.png",
        desctiption: "Tokenpuss NFT",
        link: "https://tokenpuss.com/",
    },
];

const cryptowalletportfolio = [
    {
        img: "images/cryptowallet.png",
        desctiption: "Bitcoin Libre",
        link: "https://apps.apple.com/us/app/bitcoin-libre/id1590680702",
    },
];

const stakingportfolio = [
    {
        img: "images/nearstaking.png",
        desctiption: "Near staking",
        link: "https://near-staking-tawny.vercel.app/",
    },
    {
        img: "images/canvas.png",
        desctiption: "Staking opencanvas",
        link: "https://staking.opencanvas.app/",
    },
];

const botportfolio = [
    {
        img: "images/guibot.png",
        desctiption: "NFT minting bot on Magic Eden with GUI",
        link: "#",
    },
    {
        img: "images/clibot.png",
        desctiption: "NFT minting bot with CLI",
        link: "#",
    },
];
...
export {
    meta,
    dataabout,
    customblockchainportfolio,
    dexportfolio,
    marketplaceportfolio,
    mintingsiteportfolio,
